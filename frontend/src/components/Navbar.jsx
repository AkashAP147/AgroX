          ...
          <div className="md:hidden pb-4 pt-2 border-t border-gray-100 animate-slide-down">
            <div className="flex flex-col gap-1">
              ...
              <div className="border-t border-gray-100 mt-2 pt-2">
                <div className="px-4 py-3 flex items-center gap-3 bg-gradient-to-r from-primary-50/50 to-emerald-50/50 rounded-xl mx-2 mb-2">
                ...
                {/* Mobile UPI Settings – farmers only */}
                {user.role === 'farmer' && (
                ...
                <div className="px-2 pt-2 border-t border-gray-100 mt-2">
                  <p className="px-2 pb-1.5 text-[10px] font-semibold text-gray-400 uppercase tracking-wider flex items-center gap-1">
